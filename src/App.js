...
const[productThumbImage,setProductThumbImage] = useState([])
...
const[thirdHomeProducts,setThirdHomeProducts]=useState([])
useEffect(()=>{
  axios({
    method:'get',
    ...
    console.log(x);
    setThirdHomeProducts(x)
  })
},[])

const[shopSecondProducts,setShopSecondProducts]=useState([])
useEffect(()=>{
  axios({
    method:'get',
    url:'http://localhost:9000/products'
...
console.log(l);
   ...
   console.log(f);
       ...
       const inc1=(x)=>{
        let Data1 = thirdHomeProducts.map((e)=>{
          if(e.id===x.id){
            e.count++;
      ...
      const inc=(x)=>{
        let Data = shopSecondProducts.map((n)=>{
          if(n.id===x.id){
            n.count++;
      ...
      const total=()=>{
        let data = l.reduce((x,y)=>{return x+y.productPrice*y.count},0 ) + f.reduce((e,n)=>{return e+n.productPrice*n.count},0 )
      ...
      const changeEmailAdress=(e)=>{
       ...
       const changeProductThumbImage = (e)=>{
        setProductImage(e.target.value)
       }
      ...
      const payBtn=()=>{
       ...
       
       {
        ...
        <div className='app'>
          ...
          <Routes>
          <Route path='/' element={<Home  add1={add1} thirdHomeProducts={thirdHomeProducts}/>}   />
            <Route path='/Shop' element={<Shop shopSecondProducts={shopSecondProducts} add={add} />} />
            ...
            <Route path='/newproduct' element={<NewProduct FormSubmit5={FormSubmit5} changeProductName={changeProductName} changeProductPrice={changeProductPrice} changeProductItems={changeProductItems} changeProductImage={changeProductImage} changeProductThumbImage={changeProductThumbImage} productName={productName} productPrice={productPrice} productItems={productItems} productImage={productImage} productThumbImage={productThumbImage} />}/> 
